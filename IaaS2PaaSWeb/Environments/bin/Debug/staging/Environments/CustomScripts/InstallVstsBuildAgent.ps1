...
function Download-AgentPackage
{
    ...
    do
    {
        ...
        <#
            ...
            #>
            Write-Host '.....Starting Agent Download to '$agentPackagePath
            Invoke-WebRequest -Uri "https://github.com/Microsoft/vsts-agent/releases/download/v2.120.2/vsts-agent-win7-x64-2.120.2.zip" -Method Get -OutFile "$agentPackagePath" | Out-Null
            Write-Host '.....Finished Agent Download'
            break
        }
        catch
        {
...
function Install-Agent
{
    ...
    try
    {
        ...
        write-host ".....config Args: " $agentConfigArgs
        ...
        write-host ".....AgentExePath: " $Config.AgentExePath
